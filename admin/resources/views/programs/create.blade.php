...
@section('content')
    <div class="pd-x-15 pd-t-15">
        <h3 class="tx-gray-800 mg-b-10">Create Program</h3>
    </div>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper pd-20">
            ...
            {{--<h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-20">Create New Program</h6>--}}
            {{--<p class="mg-b-25 mg-lg-b-50"></p>--}}
            <form action="{!! route('programs.create') !!}" id="program_create_form" method="post"
                  autocomplete="off">
                {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2__" name="level_of_study" id="level_of_study"
                                ...
                                @foreach(config('app.level_of_study') as $key=>$value)
                                    <option {!! old('level_of_study')==$key?'selected="selected"':'' !!} value="{!! $key !!}">
                                        {!! $value !!}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2__" name="type_of_program" id="type_of_program"
                                ...
                                @foreach(config('app.type_of_program') as $key=>$value)
                                    <option {!! old('type_of_program')==$key?'selected="selected"':'' !!} value="{!! $key !!}">
                                        {!! $value!!}
                                    </option>
                                @endforeach
                            </select>
                            <input class="form-control mg-t-10" type="text" name="type_of_program_other"
                                   id="type_of_program_other" value="{!! old('type_of_program_other') !!}"
                                   placeholder="Enter other type of program"
                                    {!! old('type_of_program')!='other'?'style="display:none;"':'' !!}>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <select class="form-control select2__" name="academic_status" id="academic_status"
                                ...
                                @foreach(config('app.academic_status') as $key=>$value)
                                    <option {!! old('academic_status')==$key?'selected="selected"':'' !!} value="{!! $key !!}">
                                        {!! $value!!}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="program_duration_weeks"
                                   ...
                                   value="{!! old('program_duration_weeks') !!}"
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="program_duration_years"
                                   ...
                                   value="{!! old('program_duration_years') !!}"
                        ...
                        <div class="form-group">
                            ...
                            <select name="program_intakes[]" class="form-control select2"
                                ...
                                @foreach($intakes as $intake)
                                    <option {!! in_array($intake->id,old('program_intakes',[]))?'selected="selected"':'' !!} value="{!! $intake->id !!}">
                                        {!! $intake->name !!}
                                    </option>
                                @endforeach
                            </select>
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#program_create_form").parsley().on('form:validate', function (formInstance) {
